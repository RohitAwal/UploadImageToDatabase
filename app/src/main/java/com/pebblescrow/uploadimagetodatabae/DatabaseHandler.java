...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        try {
            ...
            Toast.makeText(context, "Table created successfully inside your database", Toast.LENGTH_SHORT).show();
        }
        catch (Exception e){
    ...
    public ArrayList<ModelClass> getAllImagesData()
    {
        try {
           ...
           ArrayList<ModelClass> objectModelClassList= new ArrayList<>();
            ...
            {
                Toast.makeText(context, "No Value Exist in Database", Toast.LENGTH_SHORT).show();
                return null;
